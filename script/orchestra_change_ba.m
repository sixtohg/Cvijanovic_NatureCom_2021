...
cd('/Applications/MATLAB_R2015b.app/toolbox/MLToolbox/MLToolbox_R2013/MeteoLab/'),init

addpath '/Users/marco/Dropbox/estcena/scripts/common/'
savepath

workPath='/Users/marco/Dropbox/estcena/scripts/ivana_ice_fires/review/'
cd('/Users/marco/Dropbox/estcena/scripts/ivana_ice_fires/review/script/') 
...
for ifile=1:length(listGCMs_SPI)
    ...
    pred = B1(1) + B1(2) * scale_1981_2000(spi4_3,years_sim) + B1(3) * scale_1981_2000(tx_4_9,years_sim) + B1(4) * mean((1981:2000)') + B1(5) * mean((1981:2000).*(1981:2000))';
    ctrl_ens=nanmean(exp(pred(1:20)));
    control_CMIP6(ifile)=ctrl_ens;
    ice_ens=nanmean(exp(pred(21:40)));
    changes(ifile)=100*(ice_ens-ctrl_ens)/ctrl_ens;
    
    for ib=1:1000
        k=k+1;
        pred = bootb1(ib,1) + bootb1(ib,2) * scale_1981_2000(spi4_3,years_sim) + bootb1(ib,3) * scale_1981_2000(tx_4_9,years_sim) + bootb1(ib,4) * mean(years') + bootb1(ib,5) * mean((1981:2000).*(1981:2000))'';
        ctrl_ens=nanmean(exp(pred(1:20)));
        ice_ens=nanmean(exp(pred(21:40)));
...
%  save
savename=[dir_out 'change_BA_rcp85_cmip6.mat']
save(savename,'changes')
change_ba4=changes; clear changes
savename=[dir_out 'change_BA_boot_rcp85_cmip6.mat']
...
%  save
savename=[dir_out 'change_BA_rcp85.mat']
save(savename,'changes')
change_ba3=changes; clear changes
savename=[dir_out 'change_BA_boot_rcp85.mat']
save(savename,'changes_boot')
...
%  save
savename=[dir_out 'change_BA_lowice.mat']
save(savename,'changes')
savename=[dir_out 'change_BA_boot_lowice.mat']
save(savename,'changes_boot')

savename=[dir_out 'change_2_BA_lowice.mat']
save(savename,'changes_2')
savename=[dir_out 'change_2_BA_boot_lowice.mat']
...
mydata=[obs,ci(1),ci(2),control_CMIP6,control_lowice];
figure
hold on
...
%  save
savename=[dir_out 'change_BA_lowice_ecearth.mat']
save(savename,'changes')
savename=[dir_out 'change_BA_boot_lowice_ecearth.mat']
save(savename,'changes_boot')

savename=[dir_out 'change_2_BA_lowice_ecearth.mat']
save(savename,'changes_2')
savename=[dir_out 'change_2_BA_boot_lowice_ecearth.mat']
save(savename,'changes_2_boot')
...
[q1 q2 q3 fu fl ] = quartile2(dataplot(1,:,1))
nanmedian(dataplot(1,:,1))
cc
...
nomeout=[dir_fig,'boxplot_BA_all'];
